...
export default function Carousel() {
  ...
  const [items, setItems] = useState([
    <CarouselItem
      ...
      description={
        "Import your own routine or get us to create one for you! Whether you're looking to switch over or start your fitness journey we are here to support you!"
      }
    />,
    <CarouselItem
      key={2}
      ...
      description={
        "Centralize your coaching on one platform for seamless client interactions and enhanced relationships."
      }
    />,
    <CarouselItem
      key={3}
      ...
      description={
        "Montior your progress from workout to workout to ensure you are meeting your goals!"
      }
    />,
  ]);
  ...
  return (
    <div className="grid grid-rows-1 items-center h-full">
      <section className="transition-opacity ease-in-out">{items[num]}</section>
