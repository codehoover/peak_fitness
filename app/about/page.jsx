        ...
        <div className="flex flex-col pt-28 pb-60 gap-12 h-full bg-neutral-800 text-white">
            ...
            <section className="flex flex-col items-center gap-12 p-6 ">
                ...
                <p className="font-semibold sm:w-3/6"> 
                    <span className="text-orange-500"> Welcome to Peak. </span> A fitness app dedicated to 
                    providing an accessible, comprehensive, and user-friendly platform
                    for all fitness enthusiasts.
                    <br/><br/> <span className="text-orange-500"> Our mission </span> is to create a platform
            ...
            <section className="bg-zinc-900 rounded-t-3xl p-6">
                <section className="flex flex-col items-center text-center gap-6">
                    ...
                    <p className="sm:w-3/6"> We strongly believe in providing equal access to all our users.
                        I am committed to ensureing that every individual can access all
                        features of our platform without any paywalls. Join us at Peak and unlock
